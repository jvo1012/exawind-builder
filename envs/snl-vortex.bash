...
EXAWIND_MODMAP[gcc]=gcc/7.2.1
EXAWIND_MODMAP[cuda]=cuda/9.2.148

exawind_vortex_common ()
{
...
exawind_vortex_gpu ()
{
    ...
    echo "==> Activated Vortex CUDA programming environment"
}

exawind_env_gcc ()
{
    module purge
    export EXAWIND_GCC_VERSION=${EXAWIND_GCC_VERSION:-7.2.1}
    exawind_vortex_common
...
exawind_env_intel ()
{
    echo "ERROR: No intel environment setup for SNL Vortex"
}

exawind_env_clang ()
{
    echo "ERROR: No clang environment setup for SNL Vortex"
}

exawind_env_xl ()
{
    echo "ERROR: No xl environment setup for SNL Vortex"
}
